...
TRAIN_PATH = 'E:\\data\\COCO\\train2017'
BATCH_SIZE = 4
DEVICE = '/gpu:0'
FRAC_GPU = 1
...
def build_parser():
    ...
    parser.add_argument('--checkpoint-iterations',
                        type=int,
...
def check_opts(opts):
    ...
    if opts.test or opts.test_dir:
        exists(opts.test, "test.py img not found!")
        exists(opts.test_dir, "test.py directory not found!")
